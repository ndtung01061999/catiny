...
export class AlbumDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('catinyApp.album.delete.question'));
...
export default class AlbumComponentsPage {
  ...
  async deleteAlbum() {
    ...
    expect(await albumDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/catinyApp.album.delete.question/);
