...
export class PostDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('catinyApp.post.delete.question'));
...
export default class PostComponentsPage {
  ...
  async deletePost() {
    ...
    expect(await postDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/catinyApp.post.delete.question/);
