...
export class ImageDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('catinyApp.image.delete.question'));
...
export default class ImageComponentsPage {
  ...
  async deleteImage() {
    ...
    expect(await imageDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/catinyApp.image.delete.question/);
