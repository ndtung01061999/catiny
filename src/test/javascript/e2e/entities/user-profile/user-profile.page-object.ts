...
export class UserProfileDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('catinyApp.userProfile.delete.question'));
...
export default class UserProfileComponentsPage {
  ...
  async deleteUserProfile() {
    ...
    expect(await userProfileDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/catinyApp.userProfile.delete.question/);
