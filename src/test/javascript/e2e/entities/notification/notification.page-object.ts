...
export class NotificationDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('catinyApp.notification.delete.question'));
...
export default class NotificationComponentsPage {
  ...
  async deleteNotification() {
    ...
    expect(await notificationDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/catinyApp.notification.delete.question/);
