...
export const UserProfileDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="catinyApp.userProfile.delete.question">
        <Translate contentKey="catinyApp.userProfile.delete.question" interpolate={{ id: userProfileEntity.id }}>
