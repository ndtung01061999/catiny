...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NEWSFEED_LIST actions', async () => {
    ...
    it('dispatches SEARCH_NEWSFEEDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_NEWSFEED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NEWSFEED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NEWSFEED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NEWSFEED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NEWSFEED actions', async () => {
      const expectedActions = [
        {
