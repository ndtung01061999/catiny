...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GROUPPROFILE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_GROUPPROFILES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_GROUPPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GROUPPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GROUPPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GROUPPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GROUPPROFILE actions', async () => {
      const expectedActions = [
        {
