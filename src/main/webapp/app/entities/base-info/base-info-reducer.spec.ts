...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BASEINFO_LIST actions', async () => {
    ...
    it('dispatches SEARCH_BASEINFOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_BASEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BASEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BASEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BASEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BASEINFO actions', async () => {
      const expectedActions = [
        {
