...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RANKUSER_LIST actions', async () => {
    ...
    it('dispatches SEARCH_RANKUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_RANKUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RANKUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RANKUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RANKUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RANKUSER actions', async () => {
      const expectedActions = [
        {
