...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FOLLOWPAGE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FOLLOWPAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FOLLOWPAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FOLLOWPAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FOLLOWPAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FOLLOWPAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FOLLOWPAGE actions', async () => {
      const expectedActions = [
        {
