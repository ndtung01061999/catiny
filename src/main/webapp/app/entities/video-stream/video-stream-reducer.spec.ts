...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIDEOSTREAM_LIST actions', async () => {
    ...
    it('dispatches SEARCH_VIDEOSTREAMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_VIDEOSTREAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VIDEOSTREAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VIDEOSTREAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VIDEOSTREAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VIDEOSTREAM actions', async () => {
      const expectedActions = [
        {
