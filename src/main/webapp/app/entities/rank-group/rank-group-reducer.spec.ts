...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RANKGROUP_LIST actions', async () => {
    ...
    it('dispatches SEARCH_RANKGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_RANKGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RANKGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RANKGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RANKGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RANKGROUP actions', async () => {
      const expectedActions = [
        {
