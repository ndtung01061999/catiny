...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAGEPROFILE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PAGEPROFILES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PAGEPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAGEPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAGEPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAGEPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAGEPROFILE actions', async () => {
      const expectedActions = [
        {
