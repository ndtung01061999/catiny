...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FRIEND_LIST actions', async () => {
    ...
    it('dispatches FETCH_FRIEND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FRIEND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FRIEND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FRIEND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FRIEND actions', async () => {
      const expectedActions = [
        {
