...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSTLIKE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_POSTLIKES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_POSTLIKE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POSTLIKE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POSTLIKE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POSTLIKE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POSTLIKE actions', async () => {
      const expectedActions = [
        {
