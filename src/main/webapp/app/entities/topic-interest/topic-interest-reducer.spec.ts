...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOPICINTEREST_LIST actions', async () => {
    ...
    it('dispatches SEARCH_TOPICINTERESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_TOPICINTEREST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOPICINTEREST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOPICINTEREST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOPICINTEREST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOPICINTEREST actions', async () => {
      const expectedActions = [
        {
