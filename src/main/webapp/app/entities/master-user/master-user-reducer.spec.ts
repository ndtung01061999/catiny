...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './master-user.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IMasterUser, defaultValue } from 'app/shared/model/master-user.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MASTERUSER_LIST actions', async () => {
    ...
    it('dispatches SEARCH_MASTERUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_MASTERUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MASTERUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MASTERUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MASTERUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MASTERUSER actions', async () => {
      const expectedActions = [
        {
