...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './video-live-stream-buffer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIDEOLIVESTREAMBUFFER_LIST actions', async () => {
    ...
    it('dispatches SEARCH_VIDEOLIVESTREAMBUFFERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_VIDEOLIVESTREAMBUFFER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VIDEOLIVESTREAMBUFFER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VIDEOLIVESTREAMBUFFER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VIDEOLIVESTREAMBUFFER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VIDEOLIVESTREAMBUFFER actions', async () => {
      const expectedActions = [
        {
