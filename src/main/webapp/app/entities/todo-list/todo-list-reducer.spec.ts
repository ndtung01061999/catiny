...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TODOLIST_LIST actions', async () => {
    ...
    it('dispatches SEARCH_TODOLISTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_TODOLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TODOLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TODOLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TODOLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TODOLIST actions', async () => {
      const expectedActions = [
        {
