...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HANHCHINHVN_LIST actions', async () => {
    ...
    it('dispatches SEARCH_HANHCHINHVNS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_HANHCHINHVN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HANHCHINHVN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HANHCHINHVN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HANHCHINHVN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HANHCHINHVN actions', async () => {
      const expectedActions = [
        {
