...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAGEPOST_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PAGEPOSTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PAGEPOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAGEPOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAGEPOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAGEPOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAGEPOST actions', async () => {
      const expectedActions = [
        {
