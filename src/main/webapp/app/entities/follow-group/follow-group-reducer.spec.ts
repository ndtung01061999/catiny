...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FOLLOWGROUP_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FOLLOWGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FOLLOWGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FOLLOWGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FOLLOWGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FOLLOWGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FOLLOWGROUP actions', async () => {
      const expectedActions = [
        {
