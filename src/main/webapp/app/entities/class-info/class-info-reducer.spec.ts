...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASSINFO_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CLASSINFOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CLASSINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLASSINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLASSINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLASSINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLASSINFO actions', async () => {
      const expectedActions = [
        {
