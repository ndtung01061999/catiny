...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCOUNTSTATUS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ACCOUNTSTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ACCOUNTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACCOUNTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACCOUNTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACCOUNTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACCOUNTSTATUS actions', async () => {
      const expectedActions = [
        {
