...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FOLLOWUSER_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FOLLOWUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FOLLOWUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FOLLOWUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FOLLOWUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FOLLOWUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FOLLOWUSER actions', async () => {
      const expectedActions = [
        {
