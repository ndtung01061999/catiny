...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEVICESTATUS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_DEVICESTATUSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_DEVICESTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEVICESTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEVICESTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEVICESTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEVICESTATUS actions', async () => {
      const expectedActions = [
        {
