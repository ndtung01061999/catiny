...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GROUPPOST_LIST actions', async () => {
    ...
    it('dispatches SEARCH_GROUPPOSTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_GROUPPOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GROUPPOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GROUPPOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GROUPPOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GROUPPOST actions', async () => {
      const expectedActions = [
        {
