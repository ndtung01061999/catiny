...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILEINFO_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FILEINFOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FILEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILEINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILEINFO actions', async () => {
      const expectedActions = [
        {
