...
import { v4 } from 'uuid';
import { Col, FormGroup, Input, Media, Row } from 'reactstrap';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faCircle, faPhone, faVideo } from '@fortawesome/free-solid-svg-icons';
import { overridePaginationStateWithQueryParams } from 'app/shared/util/entity-utils';
import { ITEMS_PER_PAGE } from 'app/shared/util/pagination.constants';
import { getSortState } from 'react-jhipster';
import { getEntities, getSearchEntities } from 'app/modules/component/chat/message/message-group/message-group.reducer';
import {
  getEntities as getEntitiesFromMessageContent,
  getSearchEntities as getSearchEntitiesFromMessageContent,
} from 'app/modules/component/chat/message/message-content/message-content.reducer';
...
const Messages = (props: IMessageProps) => {
  ...
  const getAllEntities = () => {
    ...
    if (search) {
      props.getSearchEntitiesFromMessageContent(
        search,
        paginationState.activePage - 1,
        paginationState.itemsPerPage,
        `${paginationState.sort},${paginationState.order}`
      ...
      props.getEntitiesFromMessageContent(
        paginationState.activePage - 1,
        paginationState.itemsPerPage,
        `${paginationState.sort},${paginationState.order}`
      );
  ...
  const message = (sender, content) => {
    return (
      <Media className={props.account.login === sender ? 'justify-content-end' : 'justify-content-start'}>
        <Media
          className="mr-2"
          object
          src="data:image/jpeg;base64,"
      ...
      <Row className="messages ">
            ...
            {messageGroupList ? (
              <>
                {messageGroupList.map(messageGroup => (
                  <>{userStatusComponent(messageGroup.groupName, messageGroup.modifiedDate)}</>
                ))}
              </>
            ) : (
              <></>
        ...
        <Col className="right alert-dark">
          ...
          <Media list className="pl-0 display-block pre-scrollable vh-100">
            {messageContentList ? (
              messageContentList.map(messageContent => <>{message(messageContent.sender, messageContent.content)}</>)
            ) : (
              <></>
            )}
          </Media>
...
const mapStateToProps = (storeState: IRootState) => ({
  ...
  messageGroupList: storeState.messageGroup.entities,
  messageContentList: storeState.messageContent.entities,
});
...
const mapDispatchToProps = {
  ...
  getSearchEntities,
  getEntities,
  getSearchEntitiesFromMessageContent,
  getEntitiesFromMessageContent,
};
